...
const PROJECTS = [
  {
    ...
    tagline: '',
    taglineSub: '',
    description: 'Lucien Hsieh is a narrator telling story from paper to web. Based in Taipei, Taiwan, looking for opportunities to do storytelling or creative data visualization.',
    coverImage: '',
    link: '',
    images: [],
  },
